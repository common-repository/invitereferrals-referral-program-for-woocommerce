...
<div class="wrap">
	<div class="Invitereferrals_col">
	    ...
	    if(isset($_POST['submit']))
	    {
	    	...
	    	$this->options['Invitereferrals_Secret_key'] = $_POST['Invitereferrals_Secret_key'];
	    ...
	    <form name="<?php echo $this->plugin_id;?>_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
	        <table cellpadding="5" cellspacing="5">
	        	...
	        	<tr>
	        		<td>
	        			<label><strong>Invitereferrals Secret Key:</strong></label>
	        		</td>
	        		<td>
	        			<input style="width:100%; height: 35px; border-radius:5px;" type="text" name="Invitereferrals_Secret_key" value="<?php echo $this->options['Invitereferrals_Secret_key']??''; ?>" placeholder="Invitereferrals Secret Key">
	        		</td>
	        	</tr>
	        	<tr>
	        		<td>
	...
	<div class="Invitereferrals_desc">
		...
		<br>For Documentation <a target="_blank" href="https://docs.invitereferrals.com/">Click Here </a>
		<br>Invitereferrlas WooCommerce Page <a target="_blank" href="https://docs.invitereferrals.com/docs/wordpress-woocommerce">Click Here </a></div> 
	</div>
</div>